...
const TimelineEntryForm = ({ onSubmit, onCancel, currentStatus }) => {
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      // Correction de la validation conditionnelle
      newStatus: Yup.string().when('updateStatus', {
        is: true,
        then: (schema) => schema.required('Le nouveau statut est requis'),
        ...
        <div className="space-y-6">
          ...
          <div>
            <div className="flex items-center">
              ...
              />
              <label htmlFor="updateStatus" className="ml-2 block text-sm text-gray-900">
